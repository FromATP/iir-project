...
if __name__ == '__main__':
    ...
    output_path = Path('data/person_occur_matrix.npy')
    compressed_path = Path('data/person_occur_matrix_compressed.bin')
    
    name_list_path = Path('data/place_name.json')
    output_path = Path('data/place_occur_matrix.npy')
    compressed_path = Path('data/place_occur_matrix_compressed.bin')
